...
class AdminController extends Controller {
	...
	public function addAction() { 
		if (!empty($_POST)) {
			...
			$this->model->postUploadBook($_FILES['book']['tmp_name'], $id);
			$this->view->message('success', 'Книга добавлена');
		}
		$this->view->render('Добавить книгу'); 
	}
	...
	public function editAction() {
		...
		if (!empty($_POST)) {
			...
			if ($_FILES['book']['tmp_name']) {
				$this->model->postUploadBook($_FILES['book']['tmp_name'], $this->route['id']);
			}
		...
		$this->view->render('Редактировать книгу', $vars);
	}
